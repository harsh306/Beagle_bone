...
public class ExpandableListAdapter2 extends BaseExpandableListAdapter implements MenuItem.OnMenuItemClickListener {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if(childPosition==4) {
            ...
            txtListChild.setVisibility(convertView.GONE);


        }
        else{
            txtListChild.setText(childText);
            txtListChild.setVisibility(convertView.VISIBLE);
        }
        return convertView;
    }
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.menu_edit:
                        ...
                        String userid = (String)getChild(groupPosition,4);
                        i.putExtra("userid",userid);
                        _context.startActivity(i);
                        return true;
                    case R.id.menu_delete:
                        String random = (String)getChild(groupPosition,4);
//                      handler.deleteContact(new Integer(random));
